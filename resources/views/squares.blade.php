<div class="my-6 text-center">
	...
	<div class="overflow-hidden shadow-lg float-right" style="width:125px;">
		<img src="{{ asset('assets/images/oftalmologia.jpg') }}"/>
		<div class="px-2">
	...
	<div class="overflow-hidden shadow-lg float-right" style="width:125px;">
		<img src="{{ asset('assets/images/odontologia.jpg') }}"/>
		<div class="px-2">
	...
	<div class="overflow-hidden shadow-lg float-right" style="width:125px;">
		<img src="{{ asset('assets/images/medicina.jpg') }}"/>
		<div class="px-2">
	...
	<div class="overflow-hidden shadow-lg float-right" style="width:125px;">
		<img src="{{ asset('assets/images/pediatria.jpg') }}"/>
		<div class="px-2">
	...
	<div class="overflow-hidden shadow-lg float-right" style="width:125px;">
		<img src="{{ asset('assets/images/laboratorio.jpg') }}"/>
		<div class="px-2">
	...
	<a href="/territorios-liberados-saharauis">
	<div class="overflow-hidden shadow-lg float-right" style="width:125px;">
		<img src="{{ asset('assets/images/farmacia.jpg') }}"/>
		<div class="px-2">
	...
	<div class="overflow-hidden shadow-lg float-right" style="width:125px;">
		<img src="{{ asset('assets/images/enfermeria.jpg') }}"/>
		<div class="px-2">
